...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    performedByEmail: Schema.Attribute.String;
    performedByUid: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContractContract extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contractNumber: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    signedDate: Schema.Attribute.Date;
...
export interface ApiDealDeal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    contracts: Schema.Attribute.Relation<'oneToMany', 'api::contract.contract'>;
    contractUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer: Schema.Attribute.Relation<'manyToOne', 'api::customer.customer'>;
    ...
    stage: Schema.Attribute.Enumeration<
      ['survey', 'quote', 'negotiation', 'waiting_payment', 'closed', 'lost']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'survey'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    sePayGateway: Schema.Attribute.String;
    sePayReferenceCode: Schema.Attribute.String;
    sePayTransactionId: Schema.Attribute.String;
...
export interface ApiReminderReminder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['pending', 'completed']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pending'>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['meeting', 'call', 'task', 'payment']> &
      Schema.Attribute.DefaultTo<'task'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
